...
')
         ...
         * @return string 
         * @throws \RuntimeException
         * @see \UIIGateway\Castle\Providers\MacroServiceProvider::register()
         * @static 
         */ 
        public static function temporaryUrlAs($path, $name, $expiration, $options = [])
        {
                        return \Illuminate\Filesystem\FilesystemAdapter::temporaryUrlAs($path, $name, $expiration, $options);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Collection::mergeDeep($items);
        }
