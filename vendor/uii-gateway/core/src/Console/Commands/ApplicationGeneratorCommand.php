...
namespace UIIGateway\Core\Console\Commands;
...
class ApplicationGeneratorCommand extends Command
{
    ...
    private static $stubsPath = [
        'Develop' => __DIR__ . '/../../Coreplate/deployment.dev.bsi',
        'Stagging' => __DIR__ . '/../../Coreplate/deployment.stag.bsi',
        'Production' => __DIR__ . '/../../Coreplate/deployment.prod.bsi',
        'Env' => __DIR__ . '/../../Coreplate/env.bsi',
        'EnvDeploy' => __DIR__ . '/../../Coreplate/env.deploy.bsi',
        'EnvExample' => __DIR__ . '/../../Coreplate/env.example.bsi',
        'DockerFile' => __DIR__ . '/../../Coreplate/docker.file.bsi',
        'DockerSh' => __DIR__ . '/../../Coreplate/docker.sh.bsi',
        'DockerCompose' => __DIR__ . '/../../Coreplate/docker.compose.bsi',
    ];
