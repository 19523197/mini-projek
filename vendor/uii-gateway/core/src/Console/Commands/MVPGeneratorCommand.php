...
class MVPGeneratorCommand extends Command
{
    ...
    private static $stubsPath = [
        'Controller' => __DIR__ . '/../../Coreplate/controller.bsi',
        'Resource' => __DIR__ . '/../../Coreplate/resource.bsi',
        'Request' => __DIR__ . '/../../Coreplate/request.bsi',
        'Service' => __DIR__ . '/../../Coreplate/service.bsi',
        'Repository' => __DIR__ . '/../../Coreplate/repository.bsi',
    ...
    public function handle()
    {
        ...
        if ($continue) {
            ...
            if (!$hasFailedOperation) {
                ...
                $contents = file(base_path().'/'.static::$routesPath, FILE_IGNORE_NEW_LINES);
                if ($index = array_search($routesFind, $contents)) {
                    ...
                    $temp = implode("\n", $contents);
                    file_put_contents(base_path().'/'.static::$routesPath, $temp);
                }
